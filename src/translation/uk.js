export const uk = {
	...
	'featured-title': 'Рекомендовані пропозиції',
	'featured-subtitle':
	...
	'portfolio-subtitle':
		'Перегляньте повний портфель наших робіт, включаючи нігті, брови, вії та інше. Все, що ви бачите тут, виконала наша команда.',

	'about-title': 'Про Нас',
	'about-top':
		'Beauty Style є одним з провідних салонів краси в Гданську, відвідуваним не тільки поляками, але і українцями, німцями та представниками багатьох інших країн.',
	'about-bottom':
	...
	'recommends-late':
		'Намагайтеся не запізнюватися більше ніж на 15 хвилин. Якщо ви запізнитеся більше, ніж на 15 хвилин, зустріч буде скасована або перенесена.',
	'recommends-time':
		'Якщо ви запізнилися, повідомте нас, оскільки час для кожного клієнта обмежений.',
	...
	'recommends-burns':
		'Наявність на шкірі відкритих ранок, гнійничків, порізів, опіків (у тому числі і сонячних).',
	'recommends-bypass':
	...
	'recommends-sauna':
		'У перший день не відвідуйте сауну та не приймайте гарячий душ (ванну), і не користуйтеся гарячим душем.',
	'recommends-prohibit':
	...
	'recommends-softer': 'Волоски стають м`якими і світлішими.',
	'recommends-remnants':
